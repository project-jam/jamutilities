        ...
        const pages = [
            {
                ...
                description:
                    "some of our helpers to the profane detect package :333",
                fields: [
                    {
                        name: "skylosrahhh",
                        value: "bad words contributor (at least she knows what json means...), tester & reporter",
                        inline: false,
                    },
                    {
                        name: "omarplayz.",
                        value: "contributor to the repository & solver of the algorithm",
                        inline: false,
                    },
                    {
                        name: "slivery0659 or silver",
                        value: "tester & reporter",
                        inline: false,
                    },
                ],
            },
            {
                ...
                fields: [
                    {
                        name: "founddave",
                        value: "idea & ai trainer :3333 (im not open sourcing that)",
                        inline: false,
                    },
                    {
                        name: "omarplayz.",
                        value: "creator of the bot",
                        inline: false,
                    },
                    {
                        name: "formalsnake",
                        value: "supporter & tester",
                        inline: false,
                    },
                    {
                        name: "ryangamin",
                        value: "hoster 24/7 (thx :3)",
                        inline: false,
                    },
                    {
                        name: "orwedont",
            ...
            },
            {
                ...
                description:
                    "here are some contributors to the upcoming jamengine",
                fields: [
                    {
                        name: "ghost58_",
                        value: "3D modelist for testing purposes or for introduction :3",
                        inline: false,
                    },
                    {
                        name: "omarplayz.",
                        value: "contributor to the project (lol)",
                        inline: false,
                    },
                ],
            },
